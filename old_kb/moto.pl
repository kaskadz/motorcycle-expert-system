...
% why
why(adv, why_travel).
why(cruiser, why_relax).
why(sport, why_for_fun).
why(naked, why_for_fun).
why(naked, why_commute).
why(moped, why_commute).

% distance
distance(X, distance_near) :- distance(X, distance_mid).
distance(X, distance_mid) :- distance(X, distance_long).

distance(adv, distance_long).
distance(cruiser, distance_long).
distance(sport, distance_mid).
distance(naked, distance_near).
distance(moped, distance_near).

% experience
experience(X, experience_mid) :- experience(X, experience_big).
experience(X, experience_small) :- experience(X, experience_mid).
experience(X, experience_no) :- experience(X, experience_small).

experience(adv, experience_big).
experience(cruiser, experience_mid).
experience(sport, experience_mid).
experience(naked, experience_small).
experience(moped, experience_no).
